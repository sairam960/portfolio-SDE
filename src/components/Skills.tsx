          ...
          {skills.map((skillCategory, index) => (
            ...
            >
              ...
              <div className="text-center mb-8">
                <div className="w-16 h-16 lg:w-18 lg:h-18 mx-auto mb-6 bg-gradient-to-br from-green-500 to-blue-500 rounded-2xl flex items-center justify-center group-hover:scale-110 group-hover:rotate-3 transition-all duration-500 shadow-2xl">
        ...
        <div className="mb-20">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-6">
            {['React', 'Next.js', 'TypeScript', 'Node.js', 'Python', 'AWS', 'PostgreSQL', 'Docker'].map((tech, index) => (
              ...
              >
                <div className="w-12 h-12 bg-gradient-to-br from-green-500 to-blue-500 rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 group-hover:rotate-12 transition-all duration-300">
                  <span className="text-lg font-bold text-white">{tech.charAt(0)}</span>
                </div>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                {['AWS Certified', 'React Advanced', 'Node.js Expert', 'TypeScript Pro'].map((badge, index) => (
                  <div
                    ...
                    style={{animationDelay: `${index * 0.1}s`}}
                  >
                    <div className="w-10 h-10 bg-white/30 rounded-lg flex items-center justify-center mx-auto mb-4">
